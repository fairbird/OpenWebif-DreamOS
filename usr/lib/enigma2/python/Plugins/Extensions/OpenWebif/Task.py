...
class Task(object):
    ...
    def _run(self):
        ...
        try:
        	...
        	self.container.appClosed_conn = self.container.appClosed.connect(self.processFinished)
        	self.container.stdoutAvail_conn = self.container.stdoutAvail.connect(self.processStdout)
        	self.container.stderrAvail_conn = self.container.stderrAvail.connect(self.processStderr)
